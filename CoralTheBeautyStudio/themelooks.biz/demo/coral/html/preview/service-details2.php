...
<div class="page-title-wrap" data-bg-img="assets/img/bg/page-title-bg.png">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="page-title"><h2>Service Details 2</h2>
                    <ul class="nav">
                        <li><a href="index-2.php">Home</a></li>
                        <li class="active">Service Details 2</li>
                    </ul>
                </div>
            </div>
        </div>
...
<section class="pt-120 pb-120">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <div class="service-details-content mb-60 mb-lg-0">
                    <div class="row">
                        <div class="col-12 mb-60">
                            <div class="thumb-wrap">
                                <div class="video-wrap"><img src="assets/img/media/service-details2.png" data-rjs=""
                                                             alt=""> <a
                                        href="https://www.youtube.com/watch?v=k3Zr4zBJ5ho" class="mfp-iframe video-btn"><img
                                        src="assets/img/icon/play-icon.svg" alt="" class="svg"></a></div>
                            </div>
                            <h2>What is Hot Message Therapy?</h2>
                            <p>A quick, noninvasive, painless procedure which manually removes dead skin cells,
                                increases cellular turnover, smooths and softens skin, and provides immediate results
                                with no recovery better product penetration and flawless makeup application.</p>
                            <p>We are SWFL’s premier skincare spa. At beauty ritual skincare, we specialize in
                                transformative skincare lashes and brows. We are also the area’s only face reality acne
                                specialists.</p></div>
                        <div class="col-12 mb-60">
                            <div class="thumb-wrap"><img src="assets/img/media/service-details2-2.png" data-rjs=""
                                                         alt=""></div>
                            <h2>What is Hot Message Therapy?</h2>
                            <p>A quick, noninvasive, painless procedure which manually removes dead skin cells,
                                increases cellular turnover, smooths and softens skin, and provides immediate results
                            ...
                            <p>We are SWFL’s premier skincare spa. At beauty ritual skincare, we specialize in
                                ...
                                specialists.</p></div>
                        <div class="col-md-6">
                            <div class="thumb-wrap"><img src="assets/img/media/service-details2-3.png" data-rjs="2"
                                                         alt=""></div>
                        </div>
                        <div class="col-md-6">
                            <div class="thumb-wrap"><img src="assets/img/media/service-details2-4.png" data-rjs="2"
                                                         alt=""></div>
                        </div>
                        <div class="col-12">
                            <div class="therapy-content"><p>We are beauty premier skincare spa. At beauty ritual
                                skincare, we specialize in transformative skin-care lashes and brows. We are also the
                                area’s only face reality acne specialists.</p>
            ...
            <div class="col-lg-4">
                <div class="service-sidebar">
                    <div class="widget widget_message_care text-center text-lg-start"
                         data-bg-img="assets/img/bg/service-widget-bg.png">
                        <div class="widget-title"><h3>Massage Care</h3></div>
                        <p>Successful salon locations they decided to move.</p>
                        <ul>
                            <li>25 Minute ………………………….. $25</li>
                            <li>30 Minute ………………….………. $35</li>
                            <li>45 Minute ………………….………. $50</li>
                        ...
                        <a href="appointment.php" class="btn btn-sm"><span>Book an Appointment</span> <img
                                src="assets/img/icon/btn-arrow.svg" alt="" class="svg"></a></div>
                    <div class="widget widget_working_time text-center text-lg-start"
                         data-bg-img="assets/img/bg/service-widget-bg.png">
                        <div class="widget-title"><h3>Working Time</h3></div>
                        <p>Successful salon locations they decided to move.</p>
                        <ul>
                            <li>Monday ……………………. 8 am to 10 pm</li>
                            <li>Tuesday ……………………. 8 am to 8 pm</li>
                            <li>Wed & Thursday…. 9 am to 10 pm</li>
                            <li>Friday & Saturday ……….. 9 am to 9 pm</li>
                            <li>Sunday ……………………. Closed.</li>
                        </ul>
                    </div>
                    <div class="widget widget_add"><img src="assets/img/media/add.png" alt=""></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-8 col-lg-9 col-md-10">
                <div class="cta-content text-center"><h4>For Your First Visit</h4>
                    <h2>Get 20% Off</h2>
                    <p>You can shop brands only sold in the Aus, compare prices on your favourites products read reviews
                        before you try something new, all without leaving your home!</p><a href="shop.php" class="btn"><span>Shop Now</span>
