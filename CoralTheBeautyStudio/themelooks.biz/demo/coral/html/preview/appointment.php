...
<div class="page-title-wrap" data-bg-img="assets/img/bg/page-title-bg.png">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="page-title"><h2>Appointment</h2>
                    <ul class="nav">
            ...
            <div class="col-lg-4">
                <div class="quick-contact" data-bg-img="assets/img/bg/quick-contact-bg.png"><h3>Quick Contact</h3>
                    ...
                    <ul class="quick-contact-list pt-2">
                        ...
                        <li><i class="fas fa-envelope"></i> <a href="mailto:info@beautyqueen.com">info@beautyqueen.com</a>
                        </li>
                        <li><i class="fas fa-map-marker-alt"></i> 85 Royal Street, California<br>USA.</li>
                        <li><i class="fas fa-clock"></i> Mon - Sat: 9 am to 9 pm <span>Sunday: Closed.</span></li>
                    </ul>
