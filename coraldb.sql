...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2022 at 05:26 AM
...
-- Database: `coraldb`
--
CREATE DATABASE IF NOT EXISTS `coraldb` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `coraldb`;
...
(1, 'Dhaval Joshi', 'admin', 7898799798, 'tester1@gmail.com', 'f925916e2754e5e03f75dd58a5733251', '2019-07-25 06:21:50');
...
CREATE TABLE `tblcart` (
  ...
  `is_chekedout` tinyint(1) DEFAULT 0
...
(6, 'Jinali', 'jinu121@gmail.com', 9898989898, 'Female', 'need to come for bridal makeup with the details of the nails and the hairs', '2022-02-12 05:04:36', '2022-02-12 05:05:10');
...
CREATE TABLE `tblservices` (
  ...
  `CreationDate` timestamp NULL DEFAULT current_timestamp(),
  `service_desc` varchar(5000) NOT NULL,
...
INSERT INTO `tblservices` (`ID`, `ServiceName`, `Cost`, `CreationDate`, `service_desc`, `is_deleted`) VALUES
(2, 'Fruit Facial', 500, '2019-07-25 11:22:53', '', 'N'),
(3, 'Charcol Facial', 1000, '2019-07-25 11:23:10', '', 'N'),
(4, 'Deluxe Menicure', 500, '2019-07-25 11:23:34', '', 'Y'),
(5, 'Deluxe Pedicure', 600, '2019-07-25 11:23:47', '', 'Y'),
(6, 'Normal Menicure', 300, '2019-07-25 11:24:01', '', 'Y'),
(7, 'Normal Pedicure', 400, '2019-07-25 11:24:19', '', 'Y'),
(8, 'U-Shape Hair Cut', 250, '2019-07-25 11:24:38', '', 'N'),
(9, 'Layer Haircut', 550, '2019-07-25 11:24:53', '', 'N'),
(10, 'Rebonding', 3999, '2019-07-25 11:25:08', '', 'Y'),
(11, 'Loreal Hair Color(Full)', 1200, '2019-07-25 11:25:35', '', 'Y'),
(12, 'Body Spa', 1500, '2019-08-19 13:36:27', '', 'Y'),
(17, 'dj', 123, '2022-02-13 17:53:29', '', 'Y'),
(18, 'Bridal Makeup', 2500, '2022-02-13 18:52:37', '', 'N'),
(19, 'Mens Makeup', 70, '2022-02-13 19:35:55', '', 'N');
